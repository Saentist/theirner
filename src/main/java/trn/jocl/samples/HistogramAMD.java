...
import org.jocl.*;
import trn.DormantAddressProvider;
...
public class HistogramAMD {
    ...
    int data[];
    /**
     * < input data initialized with normalized(0 - binSize) random values
     */
    int width;
    /**
     * < width of the input
    ...
    int hostBin[];
    /**
     * < Host result for histogram bin
     */
    int midDeviceBin[];
    /**
     * < Intermittent sub-histogram bins
     */
    int deviceBin[];
    /**
     * < Device result for histogram bin
     */
     ...
     */
    long usedLocalMemory[] = new long[1];
    /**
     * < Used local memory
     */
    ...
    cl_mem dataBuf;
    /**
     * < CL memory buffer for data
     */
    cl_mem midDeviceBinBuf;
    /**
     * < CL memory buffer for intermittent device bin
     */
    cl_mem deviceBinBuf;
    /**
     * < CL memory buffer for deviceBin
     */
    ...
    int setupCL() {
        ...
        String source = readFile("kernels/Histogram_Kernels.cl");
    ...
    private static String readFile(String fileName) {
        try {
            BufferedReader br =  new BufferedReader(new InputStreamReader(DormantAddressProvider.class.getClassLoader().getResourceAsStream(fileName)));
